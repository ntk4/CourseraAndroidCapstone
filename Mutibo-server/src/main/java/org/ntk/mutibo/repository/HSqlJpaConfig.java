...
public class HSqlJpaConfig {
	...
	public DataSourceInitializer dataSourceInitializer(DataSource dataSource) {
		...
		// resourceDatabasePopulator.addScript(new FileSystemResource("./db/mutibo_db.script"));
	...
	public DataSource hsqlDataSource() {
		...
		basicDataSource.setUrl("jdbc:hsqldb:file:" + DB_FILE_NAME);// + ";shutdown=true;hsqldb.write_delay=false");
